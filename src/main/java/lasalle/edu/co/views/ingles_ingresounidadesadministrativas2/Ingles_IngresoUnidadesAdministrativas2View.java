package lasalle.edu.co.views.ingles_ingresounidadesadministrativas2;
...
@PageTitle("Ingles_Ingreso Unidades Administrativas2")
@Route("my-view15")
@Menu(order = 15, icon = LineAwesomeIconUrl.PENCIL_RULER_SOLID)
public class Ingles_IngresoUnidadesAdministrativas2View extends Composite<VerticalLayout> {

    public Ingles_IngresoUnidadesAdministrativas2View() {
        ...
        h1.setText("Administrative Units");
