package lasalle.edu.co.views.nexus;
...
public class NexusView extends Composite<VerticalLayout> {
    ...
    public NexusView() {
        ...
        h2.setText("Sistema de Información de la Oficina de Relaciones Internacionales e Interinstitucionales");
