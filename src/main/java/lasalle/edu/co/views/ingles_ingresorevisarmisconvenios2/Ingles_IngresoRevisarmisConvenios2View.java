package lasalle.edu.co.views.ingles_ingresorevisarmisconvenios2;
...
@PageTitle("Ingles_Ingreso Revisar mis Convenios2")
@Route("my-view13")
@Menu(order = 11, icon = LineAwesomeIconUrl.PENCIL_RULER_SOLID)
public class Ingles_IngresoRevisarmisConvenios2View extends Composite<VerticalLayout> {

    public Ingles_IngresoRevisarmisConvenios2View() {
