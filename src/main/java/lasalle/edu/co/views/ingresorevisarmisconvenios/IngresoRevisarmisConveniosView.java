package lasalle.edu.co.views.ingresorevisarmisconvenios;
...
@PageTitle("Ingreso Revisar mis Convenios")
@Route("my-view7")
@Menu(order = 10, icon = LineAwesomeIconUrl.PENCIL_RULER_SOLID)
public class IngresoRevisarmisConveniosView extends Composite<VerticalLayout> {

    public IngresoRevisarmisConveniosView() {
        ...
        h1.setText("Revisar mis Convenios");
        ...
        layoutColumn5.getStyle().set("width", "100%");
        ...
        layoutRow3.add(layoutColumn10);
        layoutColumn3.add(layoutRow4);
        layoutRow4.add(layoutColumn11);
