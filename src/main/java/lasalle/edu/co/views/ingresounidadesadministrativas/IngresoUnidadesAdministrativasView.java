package lasalle.edu.co.views.ingresounidadesadministrativas;
...
@PageTitle("Ingreso Unidades Administrativas")
@Route("my-view8")
@Menu(order = 14, icon = LineAwesomeIconUrl.PENCIL_RULER_SOLID)
public class IngresoUnidadesAdministrativasView extends Composite<VerticalLayout> {

    public IngresoUnidadesAdministrativasView() {
        ...
        h1.setText("Unidades Administrativas");
