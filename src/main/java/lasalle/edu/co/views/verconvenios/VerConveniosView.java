package lasalle.edu.co.views.verconvenios;
...
@PageTitle("Ver Convenios")
@Route("my-view2")
@Menu(order = 4, icon = LineAwesomeIconUrl.PENCIL_RULER_SOLID)
@Uses(Icon.class)
public class VerConveniosView extends Composite<VerticalLayout> {

    public VerConveniosView() {
        ...
        h1.setText("Alianzas Estratégicas y Convenios");
        ...
        h5.setText("Por favor seleccione los criterios de búsqueda:");
        ...
        multiSelectComboBox.setLabel("Pais");
        multiSelectComboBox.getStyle().set("width", "min-content");
        setMultiSelectComboBoxSampleData(multiSelectComboBox);
        layoutColumn4.getStyle().set("flex-grow", "1");
        multiSelectComboBox2.setLabel("Facultades y Departamentos");
        ...
        multiSelectComboBox3.setLabel("Tipo de Convenio");
        ...
        multiSelectComboBox4.setLabel("Programas");
        ...
        multiSelectComboBox5.setLabel("Modalidad del Convenio");
        ...
        multiSelectComboBox6.setLabel("Estado");
        ...
        numberField.setLabel("Convenios Encontrados");
        ...
        layoutRow8.add(layoutColumn5);
        layoutColumn5.add(multiSelectComboBox3);
        layoutRow8.add(layoutColumn6);
        layoutColumn6.add(multiSelectComboBox4);
        layoutColumn2.add(layoutRow9);
        layoutRow9.add(layoutColumn7);
        layoutColumn7.add(multiSelectComboBox5);
        layoutRow9.add(layoutColumn8);
        layoutColumn8.add(multiSelectComboBox6);
        layoutColumn2.add(layoutRow10);
        layoutRow10.add(layoutColumn9);
        layoutColumn9.add(buttonSecondary2);
        layoutRow10.add(layoutColumn10);
        layoutColumn10.add(buttonSecondary3);
        ...
        layoutRow14.add(layoutColumn15);
        layoutRow14.add(layoutRow17);
        layoutRow14.add(layoutColumn16);
        getContent().add(layoutRow15);
        layoutRow15.add(layoutColumn17);
        layoutRow15.add(h6);
        layoutRow15.add(layoutColumn18);
        getContent().add(layoutRow18);
    }
