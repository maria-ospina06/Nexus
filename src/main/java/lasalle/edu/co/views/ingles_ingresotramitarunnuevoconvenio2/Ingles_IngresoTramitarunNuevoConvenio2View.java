package lasalle.edu.co.views.ingles_ingresotramitarunnuevoconvenio2;
...
@PageTitle("Ingles_Ingreso Tramitar un Nuevo Convenio2")
@Route("my-view11")
@Menu(order = 7, icon = LineAwesomeIconUrl.PENCIL_RULER_SOLID)
public class Ingles_IngresoTramitarunNuevoConvenio2View extends Composite<VerticalLayout> {

    public Ingles_IngresoTramitarunNuevoConvenio2View() {
        ...
        h2.setText("Login for La Salle Users");
